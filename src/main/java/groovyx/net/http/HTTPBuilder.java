...
public class HTTPBuilder {
    ...
    protected Object defaultSuccessHandler(HttpResponseDecorator resp, Object parsedData)
        ...
        try {
            ...
            if (parsedData instanceof InputStream) {
                ...
                IOGroovyMethods.leftShift(buffer, parsedData);
    ...
    protected class RequestConfigDelegate {
        ...
        private final Map<Object, Closure> responseHandlers = new StringHashMap<Closure>();
        private URIBuilder uri;
        private final Map<Object, Object> headers = new StringHashMap<Object>();
